...
HD_PWD='/home/letrend/workspace/snickerdoodle/snickerdoodle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log roboy_plexus_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source roboy_plexus_wrapper.tcl -notrace
