...
HD_PWD='/home/letrend/workspace/snickerdoodle/snickerdoodle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log roboy_plexus_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source roboy_plexus_wrapper.tcl
